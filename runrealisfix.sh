...
wget -N https://raw.githubusercontent.com/RasmonT/Realis-Validator/main/realis.json
echo -e "\e[38;5;82mReplacing realis.json file... \e[39m"
rm -rf Realis.Network/realis.json
mv realis.json Realis.Network
sleep 1s 
echo -e "\e[38;5;82mremoving database... \e[39m"
rm -rf realis
sleep 2s 
echo -e "\e[38;5;82mStarting validator... \e[39m"
sudo systemctl start validator 
echo -e "\e[38;5;45mjournalctl -u validator -f -q  | ccze -A -o nolookups"
echo -e "\e[38;5;82mUse command above to check syncing... \e[39m"
